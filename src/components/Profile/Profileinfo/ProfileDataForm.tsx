...
const ProfileDataForm = (props: InjectedFormProps<ProfileDataPropsType>) => {
...
export const ProfileDataFormReduxForm = reduxForm<ProfileDataPropsType>({form: 'edit-profile'})(ProfileDataForm)